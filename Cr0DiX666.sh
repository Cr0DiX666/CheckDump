      ...
      then
        ...
        then
           ...
           then
              ...
              then
                 echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}]${O} Failed captcha => $email$del$pass ${N}|${O} Checked by Cr0DiX666"
              else
                 echo "LIVE => $email$del$pass" >> $acc-$list.txt
                 echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${G}LIVE => $email$del$pass ${N}|${G} Acc $asu ${N}|${G} Checked by Cr0DiX666"
              fi
           else
              echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${R}DIE => $email$del$pass ${N}|${R} Checked by Cr0DiX666"
              echo "bad" >> .0-$list
           fi
        else
          if [[ "$get" = "" ]]
           then  
                if [[ "$hash" = "y" ]];then
                   ...
                   echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${R}DIE => ${R}$email$del$pass ${N}|${R} Checked by Cr0DiX666"
...
| $$      | $$  | $$| $$_____/| $$      | $$_  $$ | $$  | $$| $$  | $$| $$ | $$ | $$| $$  | $$
|  $$$$$$$| $$  | $$|  $$$$$$$|  $$$$$$$| $$ \  $$|  $$$$$$$|  $$$$$$/| $$ | $$ | $$| $$$$$$$/
 \_______/|__/  |__/ \_______/ \_______/|__/  \__/ \_______/ \______/ |__/ |__/ |__/| $$____/ 
                                                                                    | $$      
                                                                                    | $$      
                                                                                    |__/      
...
Get Pro version contact me Raden Mas Ki Acuy
Thx to:${O} Cr0DiX666 - CheckDump${N}"
  ;;
   *) echo -e "[+] Thx for using this tools"
 ;;
esac
