...
#/////////////////////////////////////////////////////////////////////////
#//Author: by ./Agus Hackpath    Developer: RSecxXx@H4x0r.ID  feat Mr_Vektor.404iD                                 //
      ...
      then
        ...
        then
           ...
           then
              ...
              then
                 echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}]${O} Failed captcha => $email$del$pass ${N}|${O} Checked By RSecxXx.iD & Agus Hackpath_Tools & Mr_Vektor404iD"
              else
                 echo "LIVE => $email$del$pass" >> $acc-$list.txt
                 echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${G}LIVE => $email$del$pass ${N}|${G} Acc $asu ${N}|${G} Checked By RSecxXx.iD & Agus Hackpath_Tools & Mr_Vektor404iD"
              fi
           else
              echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${R}DIE => $email$del$pass ${N}|${R} Checked By RSecxXx.iD & Agus Hackpath_Tools Mr_Vektor.404iD"
              echo "bad" >> .0-$list
           fi
        else
          if [[ "$get" = "" ]]
           then  
                if [[ "$hash" = "y" ]];then
                   ...
                   echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${R}DIE => ${R}$email$del$pass ${N}|${R} Checked By RSecxXx.iD & Agus Hackpath_Tools & Mr_Vektor.404iD"
                ...
                if [[ "$hash" = "y" ]];then
                   ...
                   echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${G}LIVE => $email$del$pass ${N}|${G} Acc $asu ${N}|${G} Checked By RSecxXx.iD & Agus Hackpath_Tools & Mr_Vektor.404iD"
                fi
           fi
        fi
     done
...
if [[ "$hash" = "y" ]];then
   ...
   echo -e "-------[ checked RSecxXx7.ID & by Agus Hackpath Tools checker feat Mr_Vektor.404iD ]--------\n" >> $acc-$list
   echo -e "${N}[*] Done.....\n[+] Result : ${G}$acc-$list${N}"
...
Email Checker && Opensource Email Passwords Dumper In Pro Version LIMITTED EDITIONSv.10
           have a nice day Salam INDONESIA-SYNDICATE666 Gh0sT | GrayHat Sec666 Gh0sT | SECURITY AGENCY_x7 | Minang Cyber Team|Hacker Patah Hati $N
[?] ${G}RSecxXx@H4x0r.iD feat Mr_Vektor.404 TOOLS PRO LIMITTED EDITIONS MENU${N}
...
[12].   Email Passwords Dumper Pro V5.0
[13].     Email Passwords Dumper CREAZY POWER FULL PRO V25.0
[14]. ABOUT RSecxXx7.iD & Agus HackPath TOOLS CLI PRO & Mr_Vektor.404 Tools Enggine
[15]. Resso Email Checker
[16]. Mobile Legend Acount Checker
[17]. Free Fire Email Checker
[18].Bli Bli Email Checker"
...
case $d in
 ...
 ;; 
 14) echo -e "
         |${G} Mr_Vektor.404iD &RSecxXx@H4x0r.iD & Agus HACKPATH TOOLS CLI LIMMITED EDITIONS PRO VERSION ${N}|
...
-THANKS TO || INDONESIAN SYNDICATE | SECURITY AGENCY_X7|Minang Cyber Team
...
- Contact Email: Mr_Vektor.404 Gak Punya Email Bg xixixi.
Get All New Version Contact Me RSecxXx@H4x0r.iD feat Mr_Vektor.404 & Agus_HackPath
Thx to:${O} INDONESIA-SYNDICATE666 Gh0sT | GrayHat Sec666 Gh0sT | SECURITY AGENCY_x7 | Hacker Patah Hati |Minang Cyber Team - Leaked Data Community${N}"
  ;;
  15) ress="y"
     acc="resso"
     echo -e"
